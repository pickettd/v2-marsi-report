...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_pouchdb__ = __webpack_require__(487);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash__ = __webpack_require__(259);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__dropbox_dropbox__ = __webpack_require__(135);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
*/
var Data = (function () {
    function Data(/*private zone: NgZone,*/ dropbox) {
        ...
        __WEBPACK_IMPORTED_MODULE_1_pouchdb__["a" /* default */].plugin(__webpack_require__(508));
        __WEBPACK_IMPORTED_MODULE_1_pouchdb__["a" /* default */].plugin(__webpack_require__(558));
        this.resetAll();
            ...
            */
            ...
            if (result.rows && resultNumber) {
                result.rows.map(function (row) {
                    __WEBPACK_IMPORTED_MODULE_2_lodash__["merge"](inMemoryInspData, row.doc.data);
                });
                __WEBPACK_IMPORTED_MODULE_2_lodash__["merge"](_this.inspectionData.data, inMemoryInspData);
    ...
    Data.prototype.getAllTemplatesPreferences = function (username) {
        ...
        return this.db.allDocs({
            ...
            .then(function (result) {
            result.rows.map(function (row) {
                __WEBPACK_IMPORTED_MODULE_2_lodash__["merge"](returnObj, row.doc);
            });
            return returnObj;
        });
    };
                ...
                result.rows.map(function (row) {
                    for (var index = 0, len = _this.allUnits.data.length; index < len; index++) {
                        ...
                        if ((row.doc._id.indexOf('/' + unitIDWithoutPrefix + '/')) !== -1) {
                            ...
                            __WEBPACK_IMPORTED_MODULE_2_lodash__["merge"](returnReport[thisUnitID].data, row.doc.data);
                            break;
                        }
                    }
                });
...
Data = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__dropbox_dropbox__["a" /* DropboxProvider */]])
], Data);
...
var InspectionCreatorPage = (function () {
    ...
    InspectionCreatorPage.prototype.addNewPic = function () {
        ...
        if (this.camera) {
            ...
            var date = new Date();
            var fileID = date.getTime();
            var filename_2 = itemIDForPic_2 + '-' + this.auth.currentUser.username + fileID;
            ...
            this.camera.getPicture(cameraOptions)
                ...
                var thumbPromise = _this.imageResize.resize(resizeOptions)
                    ...
                    console.log('Path of resized thumb ', thumbURI);
                    return _this.dropbox.uploadAPI(thumb400Name_2, thumbURI, thumbFolder_2)
                        .then(function () {
                ...
                var originalPromise = _this.dropbox.uploadAPI(filename_2, fileURI, folder_2)
                    .then(function () {
                ...
                return Promise.all([originalPromise, thumbPromise, currentVisitPromise])
                    .then(function (resultArray) {
                    var mainPicURL = resultArray[0].url.split('www.dropbox').join('dl.dropboxusercontent');
                    var newPic = {
                        _id: new Date().getTime(),
                        src: mainPicURL,
                        thumb400: resultArray[1].url.split('www.dropbox').join('dl.dropboxusercontent'),
                        thumb800: mainPicURL,
                        fullpath: '/' + _this.auth.currentUser.username + folder_2 + '/' + filename_2
                    };
                    console.log('Got all dropbox image links. Full path to main image is: ' + newPic.fullpath);
